...
public class Engine {
    ...
    /**
     * findAllPossibleMoves repeatedly calls findValidMoves to retrieve a list
     * of all possible moves for the specified player.
     *
    ...
    private void displayFinalMessage(final int playerCount, final int computerCount) {
        if (playerCount > computerCount) {
            this.mGUI.displayMessageWindow("Yahoo", "Cê gamhô mizeravi! (c ta de hack)");
        } else if (playerCount < computerCount) {
            this.mGUI.displayMessageWindow("Sorry", "Perdeu playboy!");
        } else {
